...
static int read_io_status_2(modbus_t *ctx, int function,
                          int addr, int nb, uint8_t *data_dest)
{
    int rc;
    int req_length;
...
int modbus_read_input_bits_2(modbus_t *ctx, int addr, int nb, uint8_t *data_dest)
{
    int rc;
    ...
    rc = read_io_status_2(ctx, _FC_READ_DISCRETE_INPUTS, addr, nb, data_dest);
